...
```powershell
powershell -ExecutionPolicy Bypass -File Deployment/Tools/release.ps1 -Version 1.2.1 -BuildNumber 10
```

macOS/Linux:

```bash
Deployment/Tools/release.sh 1.2.1 10
```
...
```bash
git tag -a v1.2.1 -m "Hauckis App-Sammlung v1.2.1"
...
5. Bei `version_tag` exakt `v1.2.1` eintragen.
...
Aktueller Projektstand: **1.2.1 / Build 10**.
