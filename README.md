...
```powershell
powershell -ExecutionPolicy Bypass -File Deployment/Tools/release.ps1 -Version 1.0.4 -BuildNumber 5
```

macOS/Linux:

```bash
Deployment/Tools/release.sh 1.0.4 5
```
...
```bash
git tag -a v1.0.4 -m "Hauckis App-Sammlung v1.0.4"
...
5. Bei `version_tag` exakt `v1.0.4` eintragen.
...
Aktueller Projektstand: **1.0.4 / Build 5**.
