...
```powershell
powershell -ExecutionPolicy Bypass -File Deployment/Tools/release.ps1 -Version 1.0.2 -BuildNumber 3
```

macOS/Linux:

```bash
Deployment/Tools/release.sh 1.0.2 3
```
...
```bash
git tag -a v1.0.2 -m "Hauckis App-Sammlung v1.0.2"
...
5. Bei `version_tag` exakt `v1.0.2` eintragen.
...
Aktueller Projektstand: **1.0.2 / Build 3**.
