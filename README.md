...
```powershell
powershell -ExecutionPolicy Bypass -File Deployment/Tools/release.ps1 -Version 1.1.0 -BuildNumber 7
```

macOS/Linux:

```bash
Deployment/Tools/release.sh 1.1.0 7
```
...
```bash
git tag -a v1.1.0 -m "Hauckis App-Sammlung v1.1.0"
...
5. Bei `version_tag` exakt `v1.1.0` eintragen.
...
Aktueller Projektstand: **1.1.0 / Build 7**.
