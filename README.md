...
```powershell
powershell -ExecutionPolicy Bypass -File Deployment/Tools/release.ps1 -Version 1.0.3 -BuildNumber 4
```

macOS/Linux:

```bash
Deployment/Tools/release.sh 1.0.3 4
```
...
```bash
git tag -a v1.0.3 -m "Hauckis App-Sammlung v1.0.3"
...
5. Bei `version_tag` exakt `v1.0.3` eintragen.
...
Aktueller Projektstand: **1.0.3 / Build 4**.
